...
export const DateFilterOperatorItem: FC<FieldFilterOperatorItemProps> = ({ onChange, defaultOperatorItem }) => {
  const form = useForm({
    initialValues: {
      type: defaultOperatorItem?.type ?? 'between',
      value: defaultOperatorItem?.value ?? '$customDate'
    },
