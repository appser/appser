...
export const NumberOptionEditor: FC<FieldOptionEditorProps> = ({ onChange, column }) => {
  const form = useForm({
    initialValues: column.field === 'number'
      ? column.options
      : {
          precision: 0,
          allowNegative: false
  ...
  const precisionSelectData = useMemo(() => ([
    {
      label: '0',
      value: '0'
    },
